...
class LuxmedClient:
    ...
    def _create_session(self) -> requests.Session:
        ...
        headers = {'Origin': self.config["urls"]["luxmed_base_url"], 'Content-Type': 'application/json',
            'x-api-client-identifier': 'iPhone', 'Accept': 'application/json', 'Custom-User-Agent': CUSTOM_USER_AGENT,
